...
export const GeneralInfoFields = ({ disabled }: { disabled: boolean }) => {
  const {
    register,
    control,
    formState: { errors },
  ...
  return (
    <EventFormSection
      ...
      description="Datos base que definen cómo se presenta y valida el evento."
    >
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                helperText={errors.contactRequirement?.message as string}
              >
                <MenuItem value="EMAIL">Correo Electrónico</MenuItem>
                <MenuItem value="PHONE">Teléfono (WhatsApp)</MenuItem>
              </TextField>
            )}
          />
        </Grid>
